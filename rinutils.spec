...
Version  : 0.4.1
Release  : 2
URL      : https://github.com/shlomif/rinutils/releases/download/0.4.1/rinutils-0.4.1.tar.xz
Source0  : https://github.com/shlomif/rinutils/releases/download/0.4.1/rinutils-0.4.1.tar.xz
...
%prep
%setup -q -n rinutils-0.4.1
cd %{_builddir}/rinutils-0.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595348890
mkdir -p clr-build
pushd clr-build
